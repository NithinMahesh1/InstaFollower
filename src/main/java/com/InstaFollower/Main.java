...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread.sleep(1000);
        driver.findElement(By.xpath("//*[@id=\"signup-account-dialog\"]/div/div[1]/div/div/div/div[1]/input")).sendKeys("NahBruhWeCoolWithIt");

        // Inputs the password into Set Password input field
        Thread.sleep(5000);
        driver.findElement(By.xpath("//*[@id=\"signup-account-dialog\"]/div/div[2]/div[1]/div/div/div/div[1]/input")).sendKeys("EggMcChickenISNice");
        ...
        driver.findElement(By.xpath("//*[@id=\"login-view\"]/div[2]/div/div[1]/form/div[1]/div/div/div/div/div/input")).sendKeys("NahBruhWeCoolWithIt@tutanota.com");

        // Inputs new users Password into password input dialog
        driver.findElement(By.xpath("//*[@id=\"login-view\"]/div[2]/div/div[1]/form/div[2]/div/div/div/div/div/input")).sendKeys("EggMcChickenISNice");
